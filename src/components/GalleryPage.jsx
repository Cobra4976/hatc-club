  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex justify-between items-center h-16">
      ...
      <div className="hidden md:flex space-x-8">
        ...
        <Link to="/gallery" className="text-yellow-500">Gallery</Link>
  ...
  {mobileMenuOpen && (
    <div className="md:hidden bg-black border-t border-yellow-600">
      <div className="px-2 pt-2 pb-3 space-y-1">
        ...
        <Link to="/gallery" className="block w-full text-left px-3 py-2 text-yellow-500 hover:bg-gray-900">Gallery</Link>
